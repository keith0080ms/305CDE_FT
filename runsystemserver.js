...
(function() {
          ...
          return req.on('end', function() {
           ...
           // res.writeHead(200, {
            ...
            return res.end("good");
				...
				sendFileContent(res, "signupSystem001.html", "text/html");
  ...
  //});
							...
							dbo.collection("customers").count({"name" : "WillYip", "PassWord": "abcd1234"}, function (error, count) {
  						console.log(error, count);
              console.log("OK"+count);
							});
							
							
							dbo.collection("customers").findOne({"name" : "WillYip"}, function(err, item) {
						...
						//	data = dbo.collection("customers").find({"name" : "WillYip"}).toArray(function(err, result) {
//    if (err) throw err;
//    console.log(result);
//    db.close();
...
//	});
  ...
  //});
							...
							dbo.collection("customers").count({"name" : "WillYip"}, function (error, count) {
  						console.log(error, count);
							console.log("OK"+count);
							});
							...
							dbo.collection("customers").find({"name" : "WillYip"}).toArray(function(err, result) {
    if (err) throw err;
    console.log(result);
    db.close();
	});
	...
	//}); 
       ...
       console.log("signup");
			console.log(req.method);
				sendFileContent(res, "homepage001.html", "text/html");
			// Home page --------------------------------
			// Home page --------------------------------
		} else if (action === "/SeachList") {
       console.log("signup");
			console.log(req.method);
				sendFileContent(res, "searchsystem001.html", "text/html");
			// Home page --------------------------------
			// Home page --------------------------------
		} else if (action === "/Logined") {
       console.log("signup");
			console.log(req.method);
				sendFileContent(res, "logined.html", "text/html");
			} else if (action === "/searchuser") {
       console.log("signup");
			console.log(req.method);
				sendFileContent(res, "userdatabase.html", "text/html");
			// Home page --------------------------------
			// Home page --------------------------------
		} else  if (action === "/homepage002") {
       console.log("signup");
			console.log(req.method);
      if (req.method === "POST") {
        console.log("action = post");
    ...
    db.close();
            ...
            return res.end("good");
				...
				sendFileContent(res, "homepage002x.html", "text/html");
      }
   
    }else  if (action === "/homepage003") {
       console.log("signup");
			console.log(req.method);
      if (req.method === "POST") {
        console.log("action = post");
          ...
          return req.on('end', function() {
           ...
           // res.writeHead(200, {
            ...
            return res.end("good");
				...
				sendFileContent(res, "homepage003x.html", "text/html");
      }
   
    }else  if (action === "/homepage004") {
       console.log("signup");
			console.log(req.method);
      if (req.method === "POST") {
        console.log("action = post");
          ...
          return req.on('end', function() {
           ...
           // res.writeHead(200, {
            ...
            return res.end("good");
				...
				sendFileContent(res, "homepage004x.html", "text/html");
      }
  ...
  //});
							...
							dbo.collection("favoritelist").count({"rnum" : ""}, function (error, count) {
  						console.log(error, count);
							console.log("OK"+count);
							...
							dbo.collection("favoritelist").find({"rnum" : ""}).toArray(function(err, result) {
    if (err) throw err;
